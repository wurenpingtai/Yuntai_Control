...
public:
	...
	//测试
	int Set_Angle(unsigned char *Buffer, int Course_Angle, int Roll_Angle, int Pitch_Angle, int SpeedControl);
private:
	int mFd;
	fd_set mRd;
	...
	//测试
	int Kp_Course = 10, Ki_Course = 0;
	int Course_error = 0, Course_error_last = 0, Course_output = 0;
};
